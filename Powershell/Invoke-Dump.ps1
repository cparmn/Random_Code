#This is not mine, i did not write this... I believe this comes from Powersploit.
#I take no credit for any of this work.

function Invoke-Dump
{
      <#
      .SYNOPSIS
            Well.. i really hope they're not flagging on comments
      .DESCRIPTION
            Well.. i really hope they're not flagging on comments
      .EXAMPLE
        just run the fuction.
      #>
