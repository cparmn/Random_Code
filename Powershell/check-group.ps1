...
{
    param (
        [Parameter(Mandatory=$True,HelpMessage='Filename to search')]
        [ValidateNotNull()]
        [ValidateNotNullorEmpty()]
        [ValidatePattern(“[a-z][A-Z]”)]
        [string[]]$FILE,
                  
        [Parameter(Mandatory=$True,HelpMessage='Enter Active Directory group name to search seperated by comma')]
        [ValidateNotNull()]
        [ValidateNotNullorEmpty()]
        [string]$groups
        )
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUfmoxofHWXZ8jKNx4WvpbSDqS
# zRmgghQ+MIIEmTCCA4GgAwIBAgIPFojwOSVeY45pFDkH5jMLMA0GCSqGSIb3DQEB
...
# CQQxFgQU1tA/w2p7QuUqgaZiBWUlih9QezswDQYJKoZIhvcNAQEBBQAEggEAu3Km
# 2JC6mezLe6DmT5/G8KLQVfLc9gU2KtYb/oIJTZpHuf3MzDXmQhMvz1e/u19bJcEp
# OvwOuJgsq+XxYlbrsJCO2Bzl4EMAH1+rtrNgbDvtxI1L/mDxzg3IhI+QRldCmNaL
# gvaQ5Uq3rm08pNLI9G7wTr42pkA/COhZvZrBMGIBydO7cewQtsCX3ssxyaaUjz76
# UnUtEhexR+8UGoqRjEy1sBCYENhqUom2H1T28KfomMTkpfPLjHGpvM0EPu4fJjEz
# vkrM6B+GxRo3iSRMXoSj+7xHT8npnf738T6QbSkvTp1hm+uYMD4bpP6qJfesTJsz
# /kTJdHbpcnVBMzZ3PqGCAkMwggI/BgkqhkiG9w0BCQYxggIwMIICLAIBATCBqTCB
# lTELMAkGA1UEBhMCVVMxCzAJBgNVBAgTAlVUMRcwFQYDVQQHEw5TYWx0IExha2Ug
# Q2l0eTEeMBwGA1UEChMVVGhlIFVTRVJUUlVTVCBOZXR3b3JrMSEwHwYDVQQLExho
# dHRwOi8vd3d3LnVzZXJ0cnVzdC5jb20xHTAbBgNVBAMTFFVUTi1VU0VSRmlyc3Qt
# T2JqZWN0Ag8WiPA5JV5jjmkUOQfmMwswCQYFKw4DAhoFAKBdMBgGCSqGSIb3DQEJ
# AzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE4MTEyOTE0NTEwMVowIwYJ
# KoZIhvcNAQkEMRYEFAGVHIQccmF4QabPkHxFT/ObnPRvMA0GCSqGSIb3DQEBAQUA
# BIIBAIYUPxyQGSjRcX09UcfacOb5f3XD5XqxnMaicCSrbceA/Ih4f956Jg1u+43/
# J66wWF+YkHLL2Eyo4JuZYqOBxAmB0w6b6Fx7vNmapTWnDsxs1j5iMtg4u6JS2DmZ
# MEFP8VycKHZGQ13/IKYwB7CFIoBIZEnxXC05UO3B2+RROzYqD8UhsE0KSI/2lswS
# tr1zlCTQmhEaPbrR3scq2RBU/mGMVz4zkYezlYrci7hhW3LFLgApLSj+VGQOvIT8
# UfMPCmOXA8Qead7e8qzkiD+HxBGXc6Ibjq71EaILQsVZesiT6cs1TI+zUkC4/jp9
# 6TV6JBioc1BNUtBoRGNnINVJOmo=
